...
import (
	code0x1540ad "github.com/bitwormhole/starter-gorm-sqlite/src/demo/golang/code"
...
func autoGenConfig(cb application.ConfigBuilder) error {
	...
	// component: com0-code0x1540ad.Demo
	cominfobuilder.Next()
	cominfobuilder.ID("com0-code0x1540ad.Demo").Class("life").Aliases("").Scope("")
...
// comFactory4pComDemo : the factory of component: com0-code0x1540ad.Demo
type comFactory4pComDemo struct {

    mPrototype * code0x1540ad.Demo
...
func (inst * comFactory4pComDemo) newObject() * code0x1540ad.Demo {
	return & code0x1540ad.Demo {}
}

func (inst * comFactory4pComDemo) castObject(instance application.ComponentInstance) * code0x1540ad.Demo {
	return instance.Get().(*code0x1540ad.Demo)
}
...
func (inst * comFactory4pComDemo) getterForFieldSourcesSelector (context application.InstanceContext) datasource0x68a737.SourceManager {
	...
	if !ok {
		...
		eb.Message("bad cast")
		eb.Set("com", "com0-code0x1540ad.Demo")
